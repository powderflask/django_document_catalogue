...
DOCUMENT_CATALOGUE_LOGIN_REQUIRED = getattr(
    settings, "DOCUMENT_CATALOGUE_LOGIN_REQUIRED", appConfig.LOGIN_REQUIRED_DEFAULT
)
...
DOCUMENT_CATALOGUE_PERMISSIONS = getattr(
    settings, "DOCUMENT_CATALOGUE_PERMISSIONS", "document_catalogue.permissions"
)
...
DOCUMENT_CATALOGUE_ENABLE_EDIT_URLS = getattr(
    settings, "DOCUMENT_CATALOGUE_ENABLE_EDIT_URLS", False
)
...
DOCUMENT_CATALOGUE_MEDIA_ROOT = getattr(
    settings, "DOCUMENT_CATALOGUE_MEDIA_ROOT", "documents/"
)
...
DOCUMENT_CATALOGUE_CONTENT_TYPE_WHITELIST = getattr(
    settings, "DOCUMENT_CATALOGUE_CONTENT_TYPE_WHITELIST", None
)
# max. size in bytes, None for no limit
DOCUMENT_CATALOGUE_MAX_FILESIZE = getattr(
    settings, "DOCUMENT_CATALOGUE_MAX_FILESIZE", 10 * 1024 * 1024
)
...
DOCUMENT_CATALOGUE_LIST_VIEW_PLUGINS = getattr(
    settings,
